...
/**
 * Generated class for the RiwayatKeahlianPage page.
 *
...
@Component({
  selector: 'page-riwayat-keahlian',
  templateUrl: 'riwayat-keahlian.html',
})
export class RiwayatKeahlianPage {
	data_list:any = [];
  data:any;
  page:any;
  ...
  ionViewDidLoad() {
   ...
   getData(pid) {
      ...
      this.app_config.requestAjaxGet(this.app_config.data.site_url+"/pegawai/drh/keahlian/App/get",params,function(result){
