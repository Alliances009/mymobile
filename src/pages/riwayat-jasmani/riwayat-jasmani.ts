...
/**
 * Generated class for the RiwayatJasmaniPage page.
 *
...
@Component({
  selector: 'page-riwayat-jasmani',
  templateUrl: 'riwayat-jasmani.html',
})
export class RiwayatJasmaniPage {
	data_list:any = [];
  data:any;
  page:any;
  ...
  ionViewDidLoad() {
   ...
   getData(pid) {
      ...
      this.app_config.requestAjaxGet(this.app_config.data.site_url+"/pegawai/drh/jasmani/App/get",params,function(result){
