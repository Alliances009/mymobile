...
/**
 * Generated class for the RiwayatDapenPage page.
 *
...
@Component({
  selector: 'page-riwayat-dapen',
  templateUrl: 'riwayat-dapen.html',
})
export class RiwayatDapenPage {
	data_list:any;
  data:any;
  page:any;
  ...
  ionViewDidLoad() {
   ...
   getData(pid) {
      ...
      this.app_config.requestAjaxGet(this.app_config.data.site_url+"/pegawai/drh/dapen/App/get",params,function(result){
