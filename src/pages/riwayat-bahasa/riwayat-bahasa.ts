...
/**
 * Generated class for the RiwayatBahasaPage page.
 *
...
@Component({
  selector: 'page-riwayat-bahasa',
  templateUrl: 'riwayat-bahasa.html',
})
export class RiwayatBahasaPage {
	data_list:any =  [];
  data:any;
  page:any;
  ...
  ionViewDidLoad() {
   ...
   getData(pid) {
      ...
      this.app_config.requestAjaxGet(this.app_config.data.site_url+"/pegawai/drh/bahasa/App/get",params,function(result){
